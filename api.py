...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key, filter):
        ...
        со списком найденных питомцев, соответствующих фильтру. На данный момент фильтр может иметь
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Метод отправляет на сервер запрос об обновлении данных питомуа по указанному ID и
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет на сервер запрос для добавления фото существующему питомцу и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленного питомца"""
        headers = {'auth_key': auth_key['key']}
        data = MultipartEncoder(
            fields={
